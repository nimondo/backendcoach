...
import reducer, {
  ...
  reset,
  updateEntity,
} from './specialite-expertise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALITEEXPERTISE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPECIALITEEXPERTISE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPECIALITEEXPERTISE actions', async () => {
      const arg = { id: 20002 };
    ...
    it('dispatches UPDATE_SPECIALITEEXPERTISE actions', async () => {
      const arg = { id: 20002 };
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALITEEXPERTISE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPECIALITEEXPERTISE actions', async () => {
      const arg = 42666;
