...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEMEEXPERTISE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_THEMEEXPERTISE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_THEMEEXPERTISE actions', async () => {
      const arg = { id: 6442 };
    ...
    it('dispatches UPDATE_THEMEEXPERTISE actions', async () => {
      const arg = { id: 6442 };
    ...
    it('dispatches PARTIAL_UPDATE_THEMEEXPERTISE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_THEMEEXPERTISE actions', async () => {
      const arg = 42666;
