...
import reducer, {
  ...
  reset,
  updateEntity,
} from './seance-reservation-coach.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEANCERESERVATIONCOACH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SEANCERESERVATIONCOACH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SEANCERESERVATIONCOACH actions', async () => {
      const arg = { id: 3447 };
    ...
    it('dispatches UPDATE_SEANCERESERVATIONCOACH actions', async () => {
      const arg = { id: 3447 };
    ...
    it('dispatches PARTIAL_UPDATE_SEANCERESERVATIONCOACH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SEANCERESERVATIONCOACH actions', async () => {
      const arg = 42666;
