...
import reducer, {
  ...
  reset,
  updateEntity,
} from './offre-coach-media.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFRECOACHMEDIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OFFRECOACHMEDIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OFFRECOACHMEDIA actions', async () => {
      const arg = { id: 7530 };
    ...
    it('dispatches UPDATE_OFFRECOACHMEDIA actions', async () => {
      const arg = { id: 7530 };
    ...
    it('dispatches PARTIAL_UPDATE_OFFRECOACHMEDIA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OFFRECOACHMEDIA actions', async () => {
      const arg = 42666;
