...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COACHEXPERT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COACHEXPERT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COACHEXPERT actions', async () => {
      const arg = { id: 19121 };
    ...
    it('dispatches UPDATE_COACHEXPERT actions', async () => {
      const arg = { id: 19121 };
    ...
    it('dispatches PARTIAL_UPDATE_COACHEXPERT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COACHEXPERT actions', async () => {
      const arg = 42666;
