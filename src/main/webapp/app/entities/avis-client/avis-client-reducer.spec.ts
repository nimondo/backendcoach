...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AVISCLIENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AVISCLIENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AVISCLIENT actions', async () => {
      const arg = { id: 21784 };
    ...
    it('dispatches UPDATE_AVISCLIENT actions', async () => {
      const arg = { id: 21784 };
    ...
    it('dispatches PARTIAL_UPDATE_AVISCLIENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AVISCLIENT actions', async () => {
      const arg = 42666;
