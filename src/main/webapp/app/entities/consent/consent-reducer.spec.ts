...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './consent.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONSENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONSENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONSENT actions', async () => {
      const arg = { id: 23984 };
    ...
    it('dispatches UPDATE_CONSENT actions', async () => {
      const arg = { id: 23984 };
    ...
    it('dispatches PARTIAL_UPDATE_CONSENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONSENT actions', async () => {
      const arg = 42666;
