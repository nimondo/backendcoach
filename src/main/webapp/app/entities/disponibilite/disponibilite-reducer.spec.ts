...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPONIBILITE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISPONIBILITE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISPONIBILITE actions', async () => {
      const arg = { id: 3018 };
    ...
    it('dispatches UPDATE_DISPONIBILITE actions', async () => {
      const arg = { id: 3018 };
    ...
    it('dispatches PARTIAL_UPDATE_DISPONIBILITE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISPONIBILITE actions', async () => {
      const arg = 42666;
