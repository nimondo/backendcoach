...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFRECOACH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OFFRECOACH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OFFRECOACH actions', async () => {
      const arg = { id: 8633 };
    ...
    it('dispatches UPDATE_OFFRECOACH actions', async () => {
      const arg = { id: 8633 };
    ...
    it('dispatches PARTIAL_UPDATE_OFFRECOACH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OFFRECOACH actions', async () => {
      const arg = 42666;
