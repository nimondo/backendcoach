...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './diplome.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIPLOME_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIPLOME actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIPLOME actions', async () => {
      const arg = { id: 18993 };
    ...
    it('dispatches UPDATE_DIPLOME actions', async () => {
      const arg = { id: 18993 };
    ...
    it('dispatches PARTIAL_UPDATE_DIPLOME actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIPLOME actions', async () => {
      const arg = 42666;
